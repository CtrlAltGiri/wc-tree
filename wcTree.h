...
NODE wcTreeConstruction(int rows, int &insertedRows){
	...
	for(int i = 0; i < rows; i++){
		...
		// i is the terminal and mainI is the excel file index.
		no = 1;
	...
	// printf("Avg. Insertion Time : %lf (%d) vs %lf (%d)\n", (insertionTime / (double)inserted), inserted, (insertionTimeL / (double)insertedL) , insertedL);
